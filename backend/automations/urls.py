...
urlpatterns = [
    ...
    # Schema endpoints
    path("api/schemas/actions/<str:pk>/", views.ActionSchemaView.as_view({'get': 'retrieve'}), name="action-schema"),
    path("api/schemas/reactions/<str:pk>/", views.ReactionSchemaView.as_view({'get': 'retrieve'}), name="reaction-schema"),
