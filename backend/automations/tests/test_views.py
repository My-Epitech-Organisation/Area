...
class BaseAPITest(APITestCase):
    ...
    def setUp(self):
        ...
        self.area1 = Area.objects.create(
            ...
            reaction_config={"recipient": "user1@example.com", "subject": "Daily Report"},
...
class AreaViewSetTest(BaseAPITest):
    ...
    def test_create_area_valid(self):
        ...
        data = {
            ...
            'reaction_config': {"recipient": "test@example.com", "subject": "Test Alert"}
        }
    ...
    def test_cannot_update_others_area(self):
        ...
        self.authenticate_user(self.user1)
        url = self.get_url('area-detail', kwargs={'pk': self.area2.id})  # area2 belongs to user2
    ...
    def setUp(self):
        ...
        for i in range(25):  # More than default page size
            Area.objects.create(
                ...
                reaction=self.email_reaction,
                action_config={"hour": 9, "minute": 0, "timezone": "UTC"},
                reaction_config={"recipient": f"user{i}@example.com", "subject": f"Report {i}"},
