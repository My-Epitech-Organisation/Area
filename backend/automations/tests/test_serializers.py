...
class ServiceSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        Action.objects.create(
            service=self.service, name="new_issue", description="New issue created"
        )
        Reaction.objects.create(
            service=self.service, name="create_issue", description="Create a new issue"
        )
...
class ActionReactionSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.reaction = Reaction.objects.create(
            service=self.service, name="create_comment", description="Create a comment"
        )
...
class AreaSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.action = Action.objects.create(
            service=self.service, name="timer_daily", description="Daily timer trigger"
        )
...
class CompatibilityValidationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.email_reaction = Reaction.objects.create(
            service=self.email_service, name="send_email", description="Send email"
        )
...
class AboutServiceSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.reaction = Reaction.objects.create(
            service=self.service, name="create_comment", description="Create comment"
        )
...
class ConfigurationValidationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.email_reaction = Reaction.objects.create(
            service=self.service, name="send_email", description="Send email"
        )
    ...
    def test_email_valid_configs(self):
        ...
        valid_configs = [
            ...
            {
                "recipient": "test.user+tag@domain.co.uk",
                "subject": "Long subject",
                "body": "Email body",
            },
            {
                "recipient": "admin@localhost.localdomain",
                "subject": "Local",
