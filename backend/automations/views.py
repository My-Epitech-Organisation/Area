...
class AreaViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [filters.SearchFilter, filters.OrderingFilter] + ([DjangoFilterBackend] if DjangoFilterBackend else [])
    filterset_fields = ['status', 'action__service', 'reaction__service', 'action', 'reaction']
    search_fields = ['name', 'action__name', 'reaction__name',
                    'action__service__name', 'reaction__service__name']
